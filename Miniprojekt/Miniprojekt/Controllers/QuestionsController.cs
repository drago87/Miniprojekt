...
namespace Miniprojekt.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,theQuestion,Category")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,theQuestion,Category")] Question question)
        {
            if (ModelState.IsValid)
            {
